...
=======
```{r chart1 Amal}
>>>>>>> ceedd79a16072ad294efc2c1c9a6460530498d6b
...
Fish_glm <- glm(Comportement_banc_num ~ Longueur_max * Taille_nageoire_pectorale,
    data = Fish_data, family = binomial())
summary_(Fish_glm) |> tabularise()

#Analyse logistique du comportement grégaire en fonction des traits morphologiques
...
chart(data = Fish_data,
  ...
  labs(
    ...
    title = "Distribution du comportement schooling en fonction de la longueur"
  )
```
