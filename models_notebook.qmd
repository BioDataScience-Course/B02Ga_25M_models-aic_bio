...
La pente de la variable profondeur du corps n'est pas significatif quand il est seul, mais en interaction elle l'est pour certain niveaux de la variable vertical station.

certains niveaux de la variable vertical station ne sont pas significatif, et l'ajustement de R2 ne que 54% de données; nous allons essayer de simplifier notre modèle.
