...
-le pvalue de Fstatistique est inférieur au seuil, le modeèle est significatif dans son ensemble.
...
-La taille d’œil est influencée par la longueur du poisson et par le comportement de banc. L’interaction montre que l’effet de la taille du poisson sur l’œil dépend du comportement de banc : schooling vs non-schooling.
